...
<div class="p-6">
    ...
    <p class="text-gray-500 mb-6">Comot Langsung </p>

    <!-- Cards -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div class="bg-white p-4 rounded-xl shadow">
            <h4 class="text-sm text-gray-500">Total Sales</h4>
            <p class="text-xl font-bold text-green-600">Rp{{ number_format($totalRevenue, 0, ',', '.') }}</p>
        </div>

        <div class="bg-white p-4 rounded-xl shadow">
            <h4 class="text-sm text-gray-500">Product Sold</h4>
            <p class="text-xl font-bold">{{ $productsSold }}</p>
        </div>

        <div class="bg-white p-4 rounded-xl shadow">
            <h4 class="text-sm text-gray-500">Product Stock</h4>
